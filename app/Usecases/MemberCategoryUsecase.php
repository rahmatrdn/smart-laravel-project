...
class MemberCategoryUsecase extends Usecase
{
    public string $className;

    public function __construct()
    {
        $this->className = "MemberCategoryUsecase";
    }
    ...
    public function getAll(array $filterData = []): array
    {
        ...
        try {
            ...
            if (!empty($filterName)) {
                ...
                $data = $data->where('c.identity_no', 'like', '%' . $filterName . '%');
            }
    ...
    public function getByID(int $id): array
    {
        ...
        try {
            $data = DB::connection(DatabaseEntity::SQL_READ)
                ->table(DatabaseEntity::MEMBER_CATEGORY)
